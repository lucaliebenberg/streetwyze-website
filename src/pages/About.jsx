...
function About() {
  return (
    <>
      <div className="w-full bg-black min-h-[50vh] mb-5 p-8">
        <h1 className="text-white font-bold text-[1.6rem] mb-5">Vision</h1>
        <p className="text-white text-md font-regular">
          A safer Cape Town for travellers and residents by offering a
      ...
      <div className="w-full h-auto bg-white text-black p-8">
        <h1 className="font-bold text-[1.6rem] mb-5">Mission</h1>
        <p className="text-md font-regular">
          At StreetWyze, our mission is to empower explorers and tourists, both
        ...
        <p className="text-md font-regular">
          Our purpose is clear: to enhance the Cape Town experience by equipping
          ...
          StreetWyze, we are dedicated to crafting a journey where safety and
          exploration harmonize, instilling a profound sense of well-being and
          appreciation for all that Cape Town has to offer.
        </p>
      </div>
    </>
  );
